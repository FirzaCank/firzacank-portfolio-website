...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    stack: ["Gemini API", "LLM Extraction", "Prompt Engineering", "Sentiment Analysis", "MongoDB", "NoSQL", "pyvis", "GCP"],
    year: "2025",
    featured: true,
  },
  {
  ...
  },
  {
    ...
    stack: ["Gemini API", "LLM Extraction", "Prompt Engineering", "Python", "Cloud Run", "Google CSE", "APIFY", "Web Scraping"],
    year: "2025",
    featured: true,
  },
  {
