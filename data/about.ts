...
export const BIO_PARAGRAPHS = [
  "I build data and AI systems that generate measurable business results: revenue from recommendation models, margin recovery from financial automation, and operational speed from ML-powered document processing. ~4 years of production engineering across telco and consumer brands.",
